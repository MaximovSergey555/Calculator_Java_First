...
class Calculator {
    ...
    public static void main(String[] args) {
        ...
        if (firstNumberIsArabian && secondNumberIsArabian) {
            System.out.println(startCalcArab(inputResult));
        } else if (firstNumberIsArabian || secondNumberIsArabian) {
            System.out.println("Неудовлетворяет условию");
        } else {
            System.out.println(startCalcRoman(inputResult));
        }
    }
